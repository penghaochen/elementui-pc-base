  ...
  <div class="app-container calendar-list-container">
    ...
    <el-form ref="searchForm" :inline="true" :model="pageInfo" label-width="80px" size="small" class="demo-form-inline form-btn-box">
      <el-form-item label="AppId" prop="appId">
        <el-input v-model="pageInfo.appId" placeholder="请输入关键字"></el-input>
      </el-form-item>
      <el-form-item label="中文名称" prop="appName">
        <el-input v-model="pageInfo.appName" placeholder="请输入关键字"></el-input>
      </el-form-item>
      <el-form-item label="英文名称" prop="appNameEn">
        <el-input v-model="pageInfo.appNameEn" placeholder="请输入关键字"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="data" border>
      ...
      <el-table-column prop="appNameEn" label="英文名称" width="200">
      </el-table-column>
      ...
      <el-table-column label="操作" fixed="right" width="140">
        <template slot-scope="scope">
          <a @click="handleModal(scope.row)" :disabled="scope.row.appId != 'gateway' && hasAuthority('systemAppEdit') ?false:true">
            编辑</a>&nbsp;
    ...
    <el-dialog :title="modalTitle" :visible.sync="modalVisible" width="60%" :before-close="handleReset">
      <el-tabs v-model="current" @tab-click="handleTabClick">
        ...
        <el-tab-pane label="应用信息" name="form1">
            <el-form ref="form1" v-show="current=='form1'" :model="formItem" :rules="formItemRules" label-width="135px" size="mini">
                ...
                <el-form-item label="AppId" prop="appId">
                    <el-input v-model="formItem.appId" :disabled="true" placeholder="请输入内容"></el-input>
                </el-form-item>
                <el-form-item label="开发者" prop="developerId">
                    <el-select v-model="formItem.developerId" placeholder="请选择" style="width:100%" clearable filterable>
                ...
                <el-form-item label="应用名称" prop="appName">
                    <el-input v-model="formItem.appName" placeholder="请输入内容"></el-input>
                </el-form-item>
                <el-form-item label="英文名称" prop="appNameEn">
                    <el-input v-model="formItem.appNameEn" placeholder="请输入内容"></el-input>
                </el-form-item>
                <el-form-item label="应用类型" prop="appType">
                    <el-select v-model="formItem.appType" placeholder="请选择" style="width:100%" @change="handleOnAppTypeChange">
                ...
                <el-form-item v-if="formItem.appType === 'app'" prop="appOs" label="操作系统">
                  <el-radio-group v-model="formItem.appOs">
                    <el-radio label="ios">
                      <i type="el-icon-apple"></i>
                      <span>苹果IOS</span>
                    </el-radio>
                    <el-radio label="android">
                      <i type="el-icon-user"></i>
                      <span>安卓Android</span>
                    </el-radio>
                  </el-radio-group>
                </el-form-item>
                <el-form-item label="应用官网" prop="website">
                    <el-input v-model="formItem.website" placeholder="请输入内容"></el-input>
                </el-form-item>
        ...
        <el-tab-pane :disabled="!formItem.appId" label="开发信息" name="form2">
            <el-form ref="form2" v-show="current=='form2'" :model="formItem" :rules="formItemRules" label-width="135px" size="mini">
                ...
                <el-form-item label="用户授权范围" prop="scopes">
                  ...
                  <el-checkbox-group v-model="formItem.scopes">
                      <el-checkbox v-for="(item,index) in selectScopes" :label="item.label" :key="index"><span>{{ item.title }}</span></el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
                ...
                <el-form-item v-show="formItem.tokenValidity === '1'" label="访问令牌有效期" prop="accessTokenValidity">
                    <el-input-number :min="900" v-model="formItem.accessTokenValidity" style="width:100px"></el-input-number>
                    <span>&nbsp;&nbsp;秒</span>
                </el-form-item>
                <el-form-item v-show="formItem.tokenValidity === '1'" label="刷新令牌有效期" prop="refreshTokenValidity">
                    <el-input-number :min="900" v-model="formItem.refreshTokenValidity" style="width:100px"></el-input-number>
                    <span>&nbsp;&nbsp;秒</span>
                </el-form-item>
        ...
        <el-tab-pane :disabled="!formItem.appId" label="分配权限" name="form3">
          <el-form ref="form3" v-show="current=='form3'" :model="formItem"  label-width="100px" :rules="formItemRules">
              <el-form-item prop="expireTime" label="过期时间">
                <el-badge v-if="formItem.isExpired" text="授权已过期">
                  <el-date-picker v-model="formItem.expireTime" class="ivu-form-item-error" type="datetime"
                              placeholder="授权有效期"></el-date-picker>
                </el-badge>
                <el-date-picker v-else="" v-model="formItem.expireTime" type="datetime" placeholder="设置有效期"></el-date-picker>
              </el-form-item>
              <el-form-item prop="authorities" label="功能接口" >
                <el-transfer :data="selectApis" :titles="['选择接口', '已选择接口']" :render-content="transferRender"
                v-model="formItem.authorities" @change="handleTransferChange" filterable></el-transfer>
              </el-form-item>
            </el-form>
        </el-tab-pane>     
      </el-tabs> 
