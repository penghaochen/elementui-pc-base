  ...
  <div>
    <el-card shadow="always">
      <el-form ref="searchForm"
        ...
        <el-form-item label="通知地址" prop="url">
          <el-input type="text" v-model="pageInfo.url" placeholder="请输入关键字"/>
        </el-form-item>
        <el-form-item label="业务类型" prop="type">
          <el-input type="text" v-model="pageInfo.type" placeholder="请输入关键字"/>
        </el-form-item>
      ...
      <el-table border :data="data" :loading="loading">
        ...
        <el-table-column prop="result" label="通知结果" width="200">
          <template slot-scope="scope">
            <el-badge is-dot v-if="scope.row.result===1" type="success" text="成功"/>
    ...
    <el-drawer size="40%" :with-header="false" :visible.sync="drawer">
      <div style="padding-left:16px;padding:8px;border-bottom:1px solid  #ccc">
        <el-badge is-dot v-if="currentRow.result===1" type="success"/>
