    ...
    <el-card shadow="always">
      <el-form ref="searchForm"
        ...
        <el-form-item label="微信号" prop="openId">
          <el-input type="text" v-model="pageInfo.openId" placeholder="请输入关键字"/>
        </el-form-item>
        <el-form-item label="通知结果" prop="status">
          <el-select v-model="pageInfo.status">
            <el-option value="0" label="消息未发送"></el-option>
            <el-option value="1" label="消息发送成功"></el-option>
            <el-option value="2" label="消息发送失败"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
