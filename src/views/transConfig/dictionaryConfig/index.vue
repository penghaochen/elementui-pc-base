    ...
    <el-card shadow="always">
      <el-form ref="searchForm" :model="pageInfo" :inline="true" label-width="100px">
        <el-form-item label="响应码:" prop="rspCode">
          <el-input clearable type="text" v-model="pageInfo.rspCode" placeholder="请输入响应码！" style="width:300px"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <el-table border :data="data" :loading="loading">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <a class="linkfont" @click="openDrawer(scope.row)" style="margin-right:30px">修改</a>
      ...
      <div style="margin-left:20px">
        <template>
          <el-form ref="editForm" :model="currentEdit" label-width="120px" label-position="left" :rules="ruleValidate">
            <el-form-item label="响应码:" prop="rspCode">
              <el-input v-model="currentEdit.rspCode" placeholder="请输入响应码" style="width:220px"></el-input>
            </el-form-item>
            <el-form-item label="响应信息:" prop="rspMsg">
              <el-input v-model="currentEdit.rspMsg" placeholder="请输入响应信息" style="width:220px"></el-input>
            </el-form-item>
      ...
      <div style="margin-left:20px">
        <template>
          <el-form ref="addForm" :model="currentAdd" label-width="120px" label-position="left" :rules="ruleValidate">
            <el-form-item label="响应码:" prop="rspCode">
              <el-input v-model="currentAdd.rspCode" placeholder="请输入响应码" style="width:220px"></el-input>
            </el-form-item>
            <el-form-item label="响应信息:" prop="rspMsg">
              <el-input v-model="currentAdd.rspMsg" placeholder="请输入响应信息" style="width:220px"></el-input>
            </el-form-item>
    ...
    methods: {
      ...
      editSubmit() {
        this.$refs.editForm.validate((valid) => {
          if (valid) {
            let params = JSON.parse(JSON.stringify(this.currentEdit))
